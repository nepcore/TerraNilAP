...
class PollutedBayLogic : IMissionLogic
{
    ...
    public void Update(GameState state)
    {
        ...
        if (state.progressionState.Tier2ProgressDict.GetValueSafe(Type.Forest) >= (forestTarget * 0.06) && TerraNilAP.Session.Locations.AllMissingLocations.Contains(t2forest1))
        {
